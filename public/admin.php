...
<body style="background-color: rgb(230, 230, 230);">
    ...
    <nav class="navbar navbar-dark bg-dark fixed-top mb-5">
        <div class="container-fluid">
            ...
            <button type="button" class="btn btn-success" id="areaPrivata" data-toggle="modal"
    ...
    <div class="container">
        ...
        <div class="row justify-content-center text-center">
            <div class="col">
                <button type="button" class="btn btn-success" style="width: 300px;" id="addArticolo" data-toggle="modal"
                    data-target="#modalAddArticolo">
                    Aggiungi Articolo
                </button>
            </div>
            <div class="col">
                <button type="button" class="btn btn-success" style="width: 300px;" id="cancArticolo"
                    data-toggle="modal" data-target="#modalCancArticolo">
                    Elimina Articolo
                </button>
            </div>
            <div class="col">
                <button type="button" class="btn btn-success" style="width: 300px;" id="modificaArticolo"
                    data-toggle="modal" data-target="#modalModificaArticolo">
                    Modifica Articolo
                </button>
            </div>
            <div class="col">
                <button class="btn btn-success" style="width: 300px;" id="gestioneStock">Reset Stock</button>
            </div>
        </div>
        <hr>
    ...
    <!--MODALE ADD ARTICOLO-->
    <div class="modal fade" id="modalAddArticolo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
                    ...
                    <div class="container" style="width: 80%;">
                        ...
                        <div id="divSubModale" class="container">
                            ...
                            <div id="divChangeUsername" class="nascondi">
                                ...
                                <button type="button" class="btn btn-primary mt-3 btn-sm mb-3" style="width: 100%;"
                                    id="invioUsernameNuovo">Aggiorna Username</button> <!--BOTTONE USERNAME NUOVO-->
                            </div>
                            ...
                            <div id="divChangePassword" class="nascondi">
                                ...
                                <button type="button" class="btn btn-primary mt-3 btn-sm mb-3" style="width: 100%;"
                                    id="invioPasswordNuova">Aggiorna password</button> <!--BOTTONE PASSWORD NUOVO-->
                            </div>
                        </div>
