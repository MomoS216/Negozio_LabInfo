...
<body style="background-color: rgb(230, 230, 230);">
    ...
    <div class="container">
        ...
        if (count($prodotti) > 0) {
            ...
            echo "<table class='table table-dark table-striped text-center' id='tableArticoli'>";
            echo "<thead>";
            echo "<tr>";
            echo "<th>ID</th>";
            echo "<th>Nome</th>";
            ...
            foreach ($prodotti as $prodotto) {
                ...
                echo "<button class='btn' id='cancella" . $prodotto['id'] . "'><img src='/public/images/bin.png' alt='cancella' width='30px'></button>";
                echo "<button class='btn' id='modifica" . $prodotto['id'] . "'><img src='/public/images/modify2.png' alt='modifica' width='30px'></button>";
                echo "<button class='btn' id='restock" . $prodotto['id'] . "'><img src='/public/images/restock.png' alt='modifica' width='30px'></button>";
                echo "</td>"; 
                echo "</tr>";
            }
