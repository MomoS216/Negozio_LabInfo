        ...
        <div class="row justify-content-center ">
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <img src="/public/images/divanoEsempio.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Titolo</h5>
                        <p class="card-text">ciao ciao ciao ciao ciao ciao ciao ciao ciao ciao ciao ciao cia ociao </p>
                        <h4>500€</h4>
